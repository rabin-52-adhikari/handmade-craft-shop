...
@section('meta')
    ...
    <meta name="keywords" content="{{$product_detail->tags}}">
...
@endsection
@section('title', 'HAND CRAFT || PRODUCT DETAIL')
                            ...
                            <div class="product-des">
                                ...
                                <div class="product-buy">
                                    ...
                                    <p class="cat">Category :<a
                                            href="{{ route('product-cat', $product_detail->category->slug) }}">{{ $product_detail->category->title }}</a>
                                    </p>
