...
Route::get('/optimize-clear', function () {
    ...
    return response()->json(['message' => 'Application cache cleared and optimized!']);
});
...
Route::get('password-reset-page', 'FrontendController@UpdateForm')->name('password.page');
Route::post('update-password', 'FrontendController@updatePassword')->name('update.password');
Route::post('password-link-send', 'FrontendController@sendResetLink')->name('password.send');
